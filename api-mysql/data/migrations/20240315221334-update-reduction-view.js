...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.sequelize.query('DROP VIEW if exists reductionDataView');
    ...
    await queryInterface.sequelize.query(`CREATE VIEW ${REDUCTION_VIEW} AS
        ...
        select
          ...
          round(reduction.cost) as cost,
          round(reduction.cost / pow(discount.multiplier, reduction.year_offset)) as npv,
